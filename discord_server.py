...
def add_message_to_history(u, mess):
    chat_message = {'user': u, 'timestamp': timestamp, 'message': mess}
                ...
                if client is s:
                    ...
                    try:
                            ...
                            if message == 'get_history':
                                ...
                                if client not in usernames:
                                    ...
                                    for chat in chat_history:
                                        formatted_message = '(' + chat['timestamp'] + ') ' + chat['user'] + ': ' + chat[
                                            'message'] + '\n'
                        ...
                        if client in clients:
                            clients.remove(client)  # Ensure the client is removed on error
                        client.close()
